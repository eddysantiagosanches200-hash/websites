...
Apps using Xposed can use storage through the apps they inject, i.e., the actual access to the storage space is the app they injected instead of the Xposed module app itseXposed
